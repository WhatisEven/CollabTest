...
public class GameWorld extends World
{
    ...
    private static final Class excludeActors[] = {MessageDisplay.class, UILabel.class, ScreenLabel.class, PlayerEnergyBar.class, PlayerHungerBar.class, Player.class, InventoryUI.class, ItemHolder.class, WorkShopUI.class, WorkShopHolder.class}; // An array that contains all classes will not be affected from movements of the player
    ...
    {    
        ...
        loadPlayer();
        loadUI();
        setPaintOrder(MessageDisplay.class, UILabel.class, WorkShop.class, Inventory.class, ScreenLabel.class, PlayerEnergyBar.class, PlayerHungerBar.class, Border.class,  DropLoot.class, Player.class, NaturalResources.class); 
    }
    ...
    /**
     * A getter method that gets the state of opening of any UI 
     */
    ...
    public static void spawnLocation()
    {
        ...
        Player.setMapOffsetX(-1 * (Greenfoot.getRandomNumber(rndGrid.getImage().getWidth() - player.getImage().getWidth()) + player.getImage().getWidth() + rndGrid.getX() - rndGrid.getImage().getWidth() / 2) + imageOffsetX);
        Player.setMapOffsetY(-1 * (Greenfoot.getRandomNumber(rndGrid.getImage().getHeight() - player.getImage().getHeight()) + player.getImage().getHeight() + rndGrid.getY() - rndGrid.getImage().getHeight() / 2) + imageOffsetY);
    }
}