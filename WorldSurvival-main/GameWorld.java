...
public class GameWorld extends World
{
    ...
    private static final Class excludeActors[] = {ScreenLabel.class, PlayerEnergyBar.class, PlayerHungerBar.class, Player.class, InventoryUI.class, ItemHolder.class, WorkShopUI.class, WorkShopHolder.class}; // An array that contains all classes will not be affected from movements of the player
    ...
    {    
        ...
        loadPlayer();
        loadUI();
        setPaintOrder(UILabel.class, WorkShop.class, Inventory.class, ScreenLabel.class, PlayerEnergyBar.class, PlayerHungerBar.class, Border.class,  DropLoot.class, Player.class, NaturalResources.class); 
    }
