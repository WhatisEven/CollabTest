...
public class Player extends Actor
{
    ...
    public Player()
    {
        maxEnergyPoint = 80; // 80 maximum energy points used for sprinting purposes
        maxHungerPoint = 50;
    ...
    /**
     * A getter method that gets the player's damage for chopping actions
     */
    public static int getChopDamage()
    {
        return ItemDataManager.getToolDamage(Inventory.getToolName(), true, false);
    }
    
    /**
     * A getter method that gets the player's damage for mining actions
     */
    public static int getMineDamage()
    {
        return ItemDataManager.getToolDamage(Inventory.getToolName(), false, true);
    }
}